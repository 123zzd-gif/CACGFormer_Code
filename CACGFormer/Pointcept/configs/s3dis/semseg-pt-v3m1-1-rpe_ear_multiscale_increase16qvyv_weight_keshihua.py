...
save_path = "exp/default_ear_xi__keshihua_29800points_Dloss_weight_2.5_qvbie_test_val"
# misc custom setting
...
model = dict(
    ...
    backbone=dict(
        ...
        # ================== 新增：特征可视化相关参数 ==================
        enable_visualization=True,  # 启用特征可视化
        visualization_dir="exp/default_ear_xi__keshihua_29800points_Dloss_weight_2.5_qvbie_test_val/keshihua",  # 可视化结果保存目录
        visualize_every_n_steps=40000,  # 每100个epoch可视化一次（可以根据需要调整）40000
        # ===========================================================
    ),
    criteria=[
